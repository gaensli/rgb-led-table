...
import time
# Import the AndyPi Python module (you need to set the number of pixels in here)
...
try:
    ...
    for i in range(5):
        LEDs.setpixelcolor(ledpixels, i,
                           LEDs.Color(0, 255, 0))  # from ledpixels, sets pixel 10 (starting from 0) to green
